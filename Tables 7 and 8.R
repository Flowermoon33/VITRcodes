...
EmpSize<-function(reppower,repempinull,rovec,n,p,k,gamma){
  ...
  #------------------------------------------------------------------------------------
  y<-c(gamma=gamma,n=n,p=p,round(out0[-c(6,9)],digits=3))
  return(y)
}
#----------------------------------------------
Alpha_AdjPower<-function(reppower,repempinull,rovec,n,p,k,gamma){
  ...
  #------------------------------------------------------------------------------------
  y<-c(gamma=gamma,n=n,p=p,round(out[-c(6,9)],digits=3))
  return(y)
}
#================table 7 ============================
#----------------gamma=0-----------------------
Tab0111<-EmpSize(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=60,p=90,k=2,gamma=0)
Tab0112<-EmpSize(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=60,p=150,k=2,gamma=0)
Tab0113<-EmpSize(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=120,p=150,k=2,gamma=0)
Tab0114<-EmpSize(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=120,p=180,k=2,gamma=0)
Tab0115<-EmpSize(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=180,p=240,k=2,gamma=0)
Tab0116<-EmpSize(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=180,p=546,k=2,gamma=0)
#----------------gamma=0.3-----------------------
Tab111<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=60,p=90,k=2,gamma=0.3)
Tab112<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=60,p=150,k=2,gamma=0.3)
Tab113<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=120,p=150,k=2,gamma=0.3)
Tab114<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=120,p=180,k=2,gamma=0.3)
Tab115<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=180,p=240,k=2,gamma=0.3)
Tab116<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=180,p=546,k=2,gamma=0.3)
#------------------------------------------------
#----------------gamma=0.8-----------------------
Tab117<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=60,p=90,k=2,gamma=0.8)
Tab118<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=60,p=150,k=2,gamma=0.8)
Tab119<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=120,p=150,k=2,gamma=0.8)
Tab1110<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=120,p=180,k=2,gamma=0.8)
Tab1111<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=180,p=240,k=2,gamma=0.8)
Tab1112<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=180,p=546,k=2,gamma=0.8)
#================table 8 ============================
#----------------gamma=0-----------------------
Tab0121<-EmpSize(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=60,p=90,k=3,gamma=0)
Tab0122<-EmpSize(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=60,p=150,k=3,gamma=0)
Tab0123<-EmpSize(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=120,p=150,k=3,gamma=0)
Tab0124<-EmpSize(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=120,p=180,k=3,gamma=0)
Tab0125<-EmpSize(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=180,p=240,k=3,gamma=0)
Tab0126<-EmpSize(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=180,p=546,k=3,gamma=0)
#----------------gamma=0.3-----------------------
Tab121<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=60,p=90,k=3,gamma=0.3)
Tab122<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=60,p=150,k=3,gamma=0.3)
Tab123<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=120,p=150,k=3,gamma=0.3)
Tab124<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=120,p=180,k=3,gamma=0.3)
Tab125<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=180,p=240,k=3,gamma=0.3)
Tab126<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=180,p=546,k=3,gamma=0.3)
#------------------------------------------------
#----------------gamma=0.8-----------------------
Tab127<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=60,p=90,k=3,gamma=0.8)
Tab128<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=60,p=150,k=3,gamma=0.8)
Tab129<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=120,p=150,k=3,gamma=0.8)
Tab1210<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=120,p=180,k=3,gamma=0.8)
Tab1211<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=180,p=240,k=3,gamma=0.8)
Tab1212<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=180,p=546,k=3,gamma=0.8)
#=======================================================
TABLE7<-rbind(Tab0111,Tab0112,Tab0113,Tab0114,Tab0115,Tab0116,Tab111,Tab112,Tab113,Tab114,Tab115,Tab116,Tab117,Tab118,Tab119,Tab1110,Tab1111,Tab1112)
TABLE8<-rbind(Tab0121,Tab0122,Tab0123,Tab0124,Tab0125,Tab0126,Tab121,Tab122,Tab123,Tab124,Tab125,Tab126,Tab127,Tab128,Tab129,Tab1210,Tab1211,Tab1212)
