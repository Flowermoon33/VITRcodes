...
#================table 5 ============================
#----------------gamma=0-----------------------
Tab071<-EmpSize(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=60,p=90,k=2,gamma=0)
Tab072<-EmpSize(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=60,p=150,k=2,gamma=0)
Tab073<-EmpSize(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=120,p=150,k=2,gamma=0)
Tab074<-EmpSize(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=120,p=180,k=2,gamma=0)
Tab075<-EmpSize(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=180,p=240,k=2,gamma=0)
Tab076<-EmpSize(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=180,p=546,k=2,gamma=0)
#----------------gamma=0.3-----------------------
Tab71<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=60,p=90,k=2,gamma=0.3)
Tab72<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=60,p=150,k=2,gamma=0.3)
Tab73<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=120,p=150,k=2,gamma=0.3)
Tab74<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=120,p=180,k=2,gamma=0.3)
Tab75<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=180,p=240,k=2,gamma=0.3)
Tab76<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=180,p=546,k=2,gamma=0.3)
#------------------------------------------------
#----------------gamma=0.8-----------------------
Tab77<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=60,p=90,k=2,gamma=0.8)
Tab78<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=60,p=150,k=2,gamma=0.8)
Tab79<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=120,p=150,k=2,gamma=0.8)
Tab710<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=120,p=180,k=2,gamma=0.8)
Tab711<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=180,p=240,k=2,gamma=0.8)
Tab712<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=180,p=546,k=2,gamma=0.8)
#================table 6 ============================
#----------------gamma=0.3-----------------------
Tab081<-EmpSize(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=60,p=90,k=3,gamma=0)
Tab082<-EmpSize(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=60,p=150,k=3,gamma=0)
Tab083<-EmpSize(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=120,p=150,k=3,gamma=0)
Tab084<-EmpSize(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=120,p=180,k=3,gamma=0)
Tab085<-EmpSize(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=180,p=240,k=3,gamma=0)
Tab086<-EmpSize(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=180,p=546,k=3,gamma=0)
#----------------gamma=0.3-----------------------
Tab81<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=60,p=90,k=3,gamma=0.3)
Tab82<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=60,p=150,k=3,gamma=0.3)
Tab83<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=120,p=150,k=3,gamma=0.3)
Tab84<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=120,p=180,k=3,gamma=0.3)
Tab85<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=180,p=240,k=3,gamma=0.3)
Tab86<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=180,p=546,k=3,gamma=0.3)
#------------------------------------------------
#----------------gamma=0.8-----------------------
Tab87<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=60,p=90,k=3,gamma=0.8)
Tab88<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=60,p=150,k=3,gamma=0.8)
Tab89<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=120,p=150,k=3,gamma=0.8)
Tab810<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=120,p=180,k=3,gamma=0.8)
Tab811<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=180,p=240,k=3,gamma=0.8)
Tab812<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(0.95,0.95),n=180,p=546,k=3,gamma=0.8)
#======================================================
TABLE5<-rbind(Tab071,Tab072,Tab073,Tab074,Tab075,Tab076,Tab71,Tab72,Tab73,Tab74,Tab75,Tab76,Tab77,Tab78,Tab79,Tab710,Tab711,Tab712)
TABLE6<-rbind(Tab081,Tab082,Tab083,Tab084,Tab085,Tab086,Tab81,Tab82,Tab83,Tab84,Tab85,Tab86,Tab87,Tab88,Tab89,Tab810,Tab811,Tab812)
