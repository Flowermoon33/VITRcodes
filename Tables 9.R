...
#================table 9 ============================
#---------------gamma=0---------------------------
Sim1<-EmpSize(reppower=5000,repempinull=5000,n=120,pvec=c(40,50),rovec=c(0.75,0.75),gamma=0)
Sim2<-EmpSize(reppower=5000,repempinull=5000,n=180,pvec=c(250,300),rovec=c(0.75,0.75),gamma=0)
Sim3<-EmpSize(reppower=5000,repempinull=5000,n=200,pvec=c(1000,1100),rovec=c(0.75,0.75),gamma=0)
Sim4<-EmpSize(reppower=5000,repempinull=5000,n=250,pvec=c(1500,2000),rovec=c(0.75,0.75),gamma=0)
#------------------------------------------------
#----------------gamma=0.3-----------------------
Sim5<-Alpha_AdjPower(reppower=5000,repempinull=5000,n=120,pvec=c(40,50),rovec=c(0.75,0.75),gamma=0.1)
Sim6<-Alpha_AdjPower(reppower=5000,repempinull=5000,n=180,pvec=c(250,300),rovec=c(0.75,0.75),gamma=0.1)
Sim7<-Alpha_AdjPower(reppower=5000,repempinull=5000,n=200,pvec=c(1000,1100),rovec=c(0.75,0.75),gamma=0.1)
Sim8<-Alpha_AdjPower(reppower=5000,repempinull=5000,n=250,pvec=c(1500,2000),rovec=c(0.75,0.75),gamma=0.1)
#------------------------------------------------
#----------------gamma=0.8-----------------------
Sim9<-Alpha_AdjPower(reppower=5000,repempinull=5000,n=120,pvec=c(40,50),rovec=c(0.75,0.75),gamma=0.2)
Sim10<-Alpha_AdjPower(reppower=5000,repempinull=5000,n=180,pvec=c(250,300),rovec=c(0.75,0.75),gamma=0.2)
Sim11<-Alpha_AdjPower(reppower=5000,repempinull=5000,n=200,pvec=c(1000,1100),rovec=c(0.75,0.75),gamma=0.2)
Sim12<-Alpha_AdjPower(reppower=5000,repempinull=5000,n=250,pvec=c(1500,2000),rovec=c(0.75,0.75),gamma=0.2)
 
Table13<-rbind(Sim1,Sim2,Sim3,Sim4,Sim5,Sim6,Sim7,Sim8,Sim9,Sim10,Sim11,Sim12)
