...
#================table 3:k=3 ============================
#----------------gamma=0-----------------------
Tab051<-EmpSize(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=60,p=30,k=2,gamma=0)
Tab052<-EmpSize(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=120,p=90,k=2,gamma=0)
Tab053<-EmpSize(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=180,p=150,k=2,gamma=0)
#----------------gamma=0.3-----------------------
Tab51<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=60,p=30,k=2,gamma=0.3)
Tab52<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=120,p=90,k=2,gamma=0.3)
Tab53<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=180,p=150,k=2,gamma=0.3)
#----------------gamma=0.8-----------------------
Tab54<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=60,p=30,k=2,gamma=0.8)
Tab55<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=120,p=90,k=2,gamma=0.8)
Tab56<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=180,p=150,k=2,gamma=0.8)
#-----------------------------------------------
TABLE3<-rbind(Tab051,Tab052,Tab053,Tab51,Tab52,Tab53,Tab54,Tab55,Tab56)
#================table 4:k=2 ============================
#----------------gamma=0-----------------------
Tab061<-EmpSize(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=60,p=30,k=3,gamma=0)
Tab062<-EmpSize(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=120,p=90,k=3,gamma=0)
Tab063<-EmpSize(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=180,p=150,k=3,gamma=0)
#----------------gamma=0.3-----------------------
Tab61<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=60,p=30,k=3,gamma=0.3)
Tab62<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=120,p=90,k=3,gamma=0.3)
Tab63<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=180,p=150,k=3,gamma=0.3)
#----------------gamma=0.8-----------------------
Tab64<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=60,p=30,k=3,gamma=0.8)
Tab65<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=120,p=90,k=3,gamma=0.8)
Tab66<-Alpha_AdjPower(reppower=5000,repempinull=5000,rovec=c(-0.95,0.95),n=180,p=150,k=3,gamma=0.8)
#-------------------------------------------------
TABLE4<-rbind(Tab061,Tab062,Tab063,Tab61,Tab62,Tab63,Tab64,Tab65,Tab66)
